...
<div class="row clearfix">
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            ...
            <div class="body">
                <div class="row text-center">
                    <div class="col-6 border-right pb-2 pt-2">
                        <label class="mb-0"><strong>Request</strong></label>
                        <h4 class="font-30 font-weight-bold text-col-blue">1,254</h4>
                    </div>
                    <div class="col-6 border-right pb-2 pt-2">
                        <label class="mb-0"><strong>Improvement</strong></label>
                        <h4 class="font-30 font-weight-bold text-col-blue">1,254</h4>
                    </div>
                    <div class="col-2 border-right pb-2 pt-2">
                        <label class="mb-0">Total Tickets</label>
                        <h4 class="font-30 font-weight-bold text-col-blue">2,025</h4>
                    </div>
                    <div class="col-2 border-right pb-2 pt-2">
                        <label class="mb-0">Queue</label>
                        <h4 class="font-30 font-weight-bold text-col-blue">1,254</h4>
                    </div>
                    <div class="col-2 border-right pb-2 pt-2">
                    ...
                    <div class="col-2 border-right pb-2 pt-2">
                        <label class="mb-0">Developer</label>
                        <h4 class="font-30 font-weight-bold text-col-blue">1,254</h4>
                    </div>
                    <div class="col-2 border-right pb-2 pt-2">
                        <label class="mb-0">UAT</label>
                        <h4 class="font-30 font-weight-bold text-col-blue">1,254</h4>
                    </div>
                    <div class="col-2 border-right pb-2 pt-2">
            ...
            <div class="body">
                <div class="row text-center">
                    <div class="form-group col-3 border-right pb-2 pt-2">
